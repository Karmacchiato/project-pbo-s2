...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="kaprodi.php?page=beranda">
  <img id="logo_sibita" src="assets/img/sibita.png" width="100" height="40" />
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    ...
                    <!-- <button class="btn custom-btn-color-primary" id="btnNavbarSearch" type="button"><i class="fas fa-search"></i></button> -->
                </div>
            </form>
            <!-- Navbar-->
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="kaprodi.php?page=pengumuman">
                        ...
                        <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            ...
                            <a class="nav-link" href="kaprodi.php?page=kaprodilistjudul1">
                                <div class="sb-nav-link-icon"><i class="fas fa-1"></i></div>List Judul Mahasiswa
                                </a>
                        ...
                        <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="kaprodi.php?page=kaprodidospem">
                                    <div class="sb-nav-link-icon"><i class="fas fa-graduation-cap"></i></div>Dosen Pembimbing
                                </a>    
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="kaprodi.php?page=kaprodi_list_sempro">
                                    <div class="sb-nav-link-icon"><i class="fas fa-graduation-cap"></i></div>List Seminar Proposal
                                </a>
            ...
            if(isset($_GET['page'])){
                ...
                switch($page) {
                    ...
                    case 'kaprodilistjudul1';
                    include "kaprodi_list_judul1.php";
                    break;
                
                    case 'cekjudul';
                    include 'kaprodi_cek_judul.php';
                    break;

                    case 'cekdospem';
                    include 'kaprodi_cek_dospem.php';
                    break;

                    case 'kaprodidospem';
                    include 'kaprodi_list_dospem.php';
                    break;

                    case 'cekbimbingan';
                    include 'kaprodi_cek_bimbingan.php';
                    break;

                    case 'kaprodisempro';
                    include 'kaprodi_sempro.php';
                    break;

                    case 'kaprodi_list_sempro';
                    include 'kaprodi_list_sempro.php';
                    break;
