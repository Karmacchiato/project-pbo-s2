...
<head>
    ...
    <script>
        function updateHari() {
            var tanggalInput = document.getElementById("tanggal_bimbingan3").value;
            var date = new Date(tanggalInput);
            var hari = date.toLocaleDateString('id-ID', { weekday: 'long' });

            document.getElementById("hari_bimbingan3").value = hari;
        }
    </script>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="" method="POST" class="form-item">
                        ...
                        <div class="form-group">
                            <label for="tanggal_bimbingan3">Tanggal Bimbingan</label>
                            <input type="date" name="tanggal_bimbingan3" id="tanggal_bimbingan3" class="form-control col-md-9" onchange="updateHari()">
                        </div>

                        <!-- Tambahkan input untuk memilih hari bimbingan -->
                        <div class="form-group">
                            <label for="hari_bimbingan3">Hari Bimbingan</label>
                            <input type="text" name="hari_bimbingan3" id="hari_bimbingan3" class="form-control col-md-9" readonly>
                        </div>

                        <div class="form-group">
                        <label for="ruangan3">No. Ruangan</label>
                        <select name="ruangan3" class="form-control col-md-9"required>
...
if(isset($_POST['submit'])){
    ...
    $tanggal_bimbingan3 = $_POST['tanggal_bimbingan3'];
    $hari_bimbingan3 = $_POST['hari_bimbingan3'];
    $ruangan3 = $_POST['ruangan3'];

    $sql = "UPDATE tl_bimbingan SET tanggal_bimbingan3='$tanggal_bimbingan3', hari_bimbingan3='$hari_bimbingan3', ruangan3='$ruangan3' WHERE id_user='$id_user'";
