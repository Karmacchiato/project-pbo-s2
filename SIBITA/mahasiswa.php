...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="mahasiswa.php?page=beranda">
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="mahasiswa.php?page=beranda">
                        ...
                        <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="mahasiswa.php?page=mahasiswa_list_judul">
                                    <div class="sb-nav-link-icon"><i class="fas fa-1"></i></div>List Judul
                                </a>
                        ...
                        <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="mahasiswa.php?page=dosenpembimbing">
                        ...
                        <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="mahasiswa.php?page=seminarproposal">
            ...
            if(isset($_GET['page'])){
                ...
                switch($page) {
                    ...
                    case 'pengajuanjudul1';
                    include "pengajuanjudul1.php";
                    break;

                    case 'dosenpembimbing';
                    include 'dosenpembimbing.php';
                    break;

                    case 'seminarproposal';
                    include 'seminarproposal.php';
                    break;

                    case 'jadwalbimbingan';
                    include 'jadwal_bimbingan.php';
                    break;

                    case 'mahasiswa_list_judul';
                    include 'mahasiswa_list_judul.php';
                    break;

                    case 'komendosen';
                    include 'komendosen.php';
                    break;

                    case 'lihatkomen';
                    include 'lihatkomen.php';
                    break;
